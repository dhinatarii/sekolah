                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-3 text-center">
                            <a href="<?php echo base_url('guru/profile') ?>" style="text-decoration:none">
                                <i class="fas fa-4x fa-user-circle text-info"></i>
                                <p class="nav-link small text-info">Profile</p>
                            </a>
                        </div>
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('guru/nilai') ?>" style="text-decoration:none">
                                <i class="text-info fas fa-4x fa-sort-numeric-down"></i>
                                <p class="nav-link small text-info">Input Nilai</p>
                            </a>
                        </div>
                        <div class="col-md-3 text-info text-center">
                            <a href="<?php echo base_url('guru/laporannilai') ?>" style="text-decoration:none">

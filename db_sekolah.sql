...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2024 at 07:59 AM
...
--
-- Table structure for table `tb_deskripsi_nilai`
--

CREATE TABLE `tb_deskripsi_nilai` (
  `id_deskripsi` int(10) NOT NULL,
  `id_datasiswa` int(11) NOT NULL,
  `id_mapel` int(10) NOT NULL,
  `id_tahun` int(10) NOT NULL,
  `semester` enum('Ganjil','Genap') NOT NULL,
  `jenis_penilaian` enum('Pengetahuan','Keterampilan','Sikap') NOT NULL,
...
CREATE TABLE `tb_nilai` (
  ...
  `jenis` varchar(20) NOT NULL,
  `aspek_penilaian` enum('Pengetahuan','Keterampilan','Sikap') NOT NULL,
  `nilai` float NOT NULL,
  `id_kd` int(10) NOT NULL,
  `id_datasiswa` int(11) NOT NULL,
  `nilai_Remidi` float DEFAULT NULL,
  `is_Remidi` tinyint(1) NOT NULL DEFAULT 0,
  `status_tuntas` enum('Tuntas','Tidak Tuntas') DEFAULT NULL,
  `keterangan` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_sikap` (
  ...
  `id_datasiswa` int(11) NOT NULL,
  `rata-rata` float DEFAULT NULL,
  `predikat` enum('SB','B','C','K') DEFAULT NULL,
...
--
-- Indexes for table `tb_deskripsi_nilai`
--
ALTER TABLE `tb_deskripsi_nilai`
  ADD PRIMARY KEY (`id_deskripsi`),
  ADD KEY `fk_deskripsi_datasiswa` (`id_datasiswa`),
  ADD KEY `fk_deskripsi_mapel` (`id_mapel`),
  ADD KEY `fk_deskripsi_tahun` (`id_tahun`);
...
--
-- AUTO_INCREMENT for table `tb_deskripsi_nilai`
--
ALTER TABLE `tb_deskripsi_nilai`
  MODIFY `id_deskripsi` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `tb_deskripsi_nilai`
--
ALTER TABLE `tb_deskripsi_nilai`
  ADD CONSTRAINT `fk_deskripsi_datasiswa` FOREIGN KEY (`id_datasiswa`) REFERENCES `tb_datasiswa` (`id_datasiswa`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_deskripsi_mapel` FOREIGN KEY (`id_mapel`) REFERENCES `tb_matapelajaran` (`id_mapel`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_deskripsi_tahun` FOREIGN KEY (`id_tahun`) REFERENCES `tb_tahunajaran` (`id_tahun`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tb_sikap`
  ADD CONSTRAINT `tb_sikap_ibfk_1` FOREIGN KEY (`id_datasiswa`) REFERENCES `tb_datasiswa` (`id_datasiswa`) ON DELETE CASCADE,
  ADD CONSTRAINT `tb_sikap_ibfk_2` FOREIGN KEY (`id_tahun`) REFERENCES `tb_tahunajaran` (`id_tahun`) ON DELETE CASCADE;
